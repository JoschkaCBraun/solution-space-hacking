#!/usr/bin/env python3
"""
Run comparison experiment: benign vs malign setups.
Generates outputs for all three setups on the same set of problems.
"""
...
async def main():
    ...
    experiment_dir = Path("data/comparison_experiments") / timestamp
    ...
    output_files["malign_avoid_for"] = await run_single_setup(
        evaluator,
        args.split,
        args.n_problems,
        "malign_avoid_for",
    ...
    output_files["malign_use_helpers"] = await run_single_setup(
        evaluator,
        args.split,
        args.n_problems,
        "malign_use_helpers",
